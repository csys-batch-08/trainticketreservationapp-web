<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
	pageEncoding="ISO-8859-1" import="com.berbin.controller.*"%>
...
<body>
	<div id="nav">
		<ul>
            ...
            &Usermobileno=${userData.getUserMobileNumber()}">Update
					Profile</a></li>
			...
			<li>
				<div id="username">
					<label for="username"> Hello _ ${userData.getUserName()}</label>
				</div>
			...
			<form action="FilterTrainController" method="post">
				<div id="searchlocation">
					...
					<th>
						<tr>
							<td><div class="fromto">
									<span>DESTINATION</span><br> <input
										name="destinationlocation" id="destinationlocation"
										placeholder="To" list="destination">
						...
						<tr>
							<div class="fromto">
								<span>SOURCE</span><br> <input name="sourcelocation"
									id="sourcelocation" placeholder="From" list="source">
								<datalist id="source">
									<option value="madurai">Madurai</option>
									<option value="chennai">Chennai</option>
									<option value="nagercoil">Nagercoil</option>
							...
							<td><div class="fromto">
									<span>DATE</span><br> <input type="date" id="datefield"
										name="date">
								</div>
						</tr>
						</tr>
