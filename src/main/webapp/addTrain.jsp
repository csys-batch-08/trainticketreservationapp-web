			...
			<table id="logintable">
				...
				<tr>
					...
					<td><input type="number" name="trainnumber" id="trnumber"
						pattern="[0-9]" placeholder="Enter trainnumber" required><br>
						<br></td>
					</th>
				</tr>

				<tr>
					<th id="trsource"><label for="trainsource">Train
							Source:</label>
					<td><input type="text" name="trainsource" id="trainsource"
						pattern="[a-zA-Z]+" placeholder="Enter train source" required><br>
						<br></td>
					</th>
				</tr>
				<tr>
					<th id="trdestination"><label for="traindestination">Train
							Destination:</label>
					<td><input type="text" name="traindestination"
						id="trdestination" pattern="[a-zA-Z]+"
						placeholder="Enter train destination" required><br> <br></td>
					</th>
				</tr>
				<tr>
					<th id="trdeparture"><label for="traindeparturetime">Train
							Departure Time:</label>
					<td><input type="datetime-local" name="traindeparturetime"
						id="trdestime" placeholder="Enter detination time" required><br>
						<br></td>
					</th>
				</tr>
				<tr>
					<th id="trarraival"><label for="trainarrivaltime">Train
							Arrival Time:</label>
					<td><input type="datetime-local" name="trainarrivaltime"
						id="trarrtime" placeholder="Enter arrival time" required><br>
						<br></td>
					</th>
				</tr>
				<tr>
					<th id="totalseat"><label for="totalseat">Total Seat:</label>
					<td><input type="number" name="totalseat" id="trtotalseat"
						pattern="[0-9]" min="0" placeholder="Enter total seat" required><br>
						<br></td>
					</th>
				</tr>
				<tr>
					<th id="ticketprice"><label for="ticketprice">Ticket
							Price:</label>
					<td><input type="number" name="ticketprice" id="trticketprice"
						min="0" placeholder="Enter ticket price" required><br>
						<br></td>
					</th>
				</tr>
				<br>
				<tr>
					...
					<th id="butadd">
						<button class="buttonadd" id="addtrres" type="reset">Reset</button>
					</th>
				</tr>
			</table>
