...
<body>
	<div class="signup">
			...
			<table id="logintable">
				<tr>
					...
					<td><input type="text" name="username"
						value="${userModel.getUserName()}" disabled="disabled"
						id="username" required><br> <br>
					</th>
					</td>
				</tr>
				<tr>
					<th id="balance"><label for="available balance">Available
							Balance:</label>
					<td><input type="text" name="" id="availablebalance"
						value="${userModel.getUserwallet()}" disabled="disabled" required><br>
						<br>
					</th>
					</td>
				</tr>
				...
				<tr>
					<th id="subsign">
						<button class="buttonsignup" id="subsignup" type="submit">To
							Add Money</button>
					</th>
				</tr>
			</table>
		...
		<a href="UserHomePageController"><button type="submit"
				id="ressignup" class="buttonsignup">Back to HomePage</button></a>
	</div>
</body>
</html>